...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2020 at 10:07 AM
...
CREATE TABLE `datas` (
  ...
  `anaemia` varchar(7) DEFAULT NULL,
  `creatinine_phosphokinase` varchar(24) DEFAULT NULL,
  `diabetes` varchar(8) DEFAULT NULL,
  `ejection_fraction` varchar(17) DEFAULT NULL,
  `high_blood_pressure` varchar(19) DEFAULT NULL,
  `platelets` varchar(9) DEFAULT NULL,
  `serum_creatinine` varchar(16) DEFAULT NULL,
  `serum_sodium` varchar(12) DEFAULT NULL,
  `sex` varchar(3) DEFAULT NULL,
  `smoking` varchar(7) DEFAULT NULL,
  `time` varchar(4) DEFAULT NULL,
  `DEATH_EVENT` varchar(11) DEFAULT NULL
...
INSERT INTO `datas` (`age`, `anaemia`, `creatinine_phosphokinase`, `diabetes`, `ejection_fraction`, `high_blood_pressure`, `platelets`, `serum_creatinine`, `serum_sodium`, `sex`, `smoking`, `time`, `DEATH_EVENT`) VALUES
...
('70', '0', '69', '0', '40', '0', '293000', '1.7', '136', '0', '0', '75', '1'),
...
('50', '0', '369', '1', '25', '0', '252000', '1.6', '136', '1', '0', '90', '1'),
('70', '1', '143', '0', '60', '0', '351000', '1.3', '137', '0', '0', '90', '0'),
...
('60', '1', '231', '1', '25', '0', '194000', '1.7', '140', '1', '0', '120', '1'),
('52', '1', '58', '0', '35', '0', '277000', '1.4', '136', '0', '0', '120', '0'),
('50', '0', '250', '0', '25', '0', '262000', '1', '136', '1', '1', '120', '1'),
...
('50', '1', '2334', '1', '35', '0', '75000', '0.9', '142', '0', '0', '126', '0'),
('45', '0', '2442', '1', '30', '0', '334000', '1.1', '139', '1', '0', '129', '0'),
...
('50', '1', '115', '0', '20', '0', '189000', '0.8', '139', '1', '0', '146', '1'),
...
('50', '0', '582', '0', '50', '0', '153000', '0.6', '134', '0', '0', '172', '0'),
...
('80', '0', '582', '1', '35', '0', '350000', '2.1', '134', '1', '0', '174', '1'),
...
('47', '0', '582', '0', '25', '0', '130000', '0.8', '134', '1', '0', '201', '1'),
('58', '0', '582', '1', '25', '0', '504000', '1', '138', '1', '0', '205', '0'),
('75', '0', '675', '1', '60', '0', '265000', '1.4', '125', '0', '0', '205', '0'),
('58', '1', '57', '0', '25', '0', '189000', '1.3', '132', '1', '1', '205', '1'),
...
('54', '0', '582', '1', '38', '0', '264000', '1.8', '134', '1', '0', '213', '1'),
('61', '1', '80', '1', '38', '0', '282000', '1.4', '137', '1', '0', '213', '0'),
('55', '0', '2017', '0', '25', '0', '314000', '1.1', '138', '1', '0', '214', '0'),
('64', '0', '143', '0', '25', '0', '246000', '2.4', '135', '1', '0', '214', '1'),
('40', '0', '624', '0', '35', '0', '301000', '1', '142', '1', '1', '214', '0'),
('53', '0', '207', '1', '40', '0', '223000', '1.2', '130', '0', '0', '214', '0'),
('50', '0', '2522', '0', '30', '1', '404000', '0.5', '139', '0', '0', '214', '1'),
...
('65', '0', '326', '0', '38', '0', '294000', '1.7', '139', '0', '0', '220', '1'),
('58', '0', '132', '1', '38', '1', '253000', '1', '139', '1', '0', '230', '0'),
('45', '1', '66', '1', '25', '0', '233000', '0.8', '135', '1', '0', '230', '1'),
...
('56', '1', '135', '1', '38', '0', '133000', '1.7', '140', '1', '0', '244', '1'),
('45', '0', '582', '1', '38', '0', '302000', '0.9', '140', '0', '0', '244', '0'),
('40', '0', '582', '1', '35', '0', '222000', '1', '132', '1', '0', '244', '0'),
('44', '0', '582', '1', '30', '1', '263358.03', '1.6', '130', '1', '1', '244', '1'),
...
('42', '0', '64', '0', '30', '0', '215000', '3.8', '128', '1', '1', '250', '1'),
...
('50', '0', '196', '0', '45', '0', '395000', '1.6', '136', '1', '1', '285', '1');

-- --------------------------------------------------------

--
-- Table structure for table `prediction_rate`
--

CREATE TABLE `prediction_rate` (
  `predict` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `prediction_rate`
--

INSERT INTO `prediction_rate` (`predict`) VALUES
(89.12);
COMMIT;
